let vm = new Vue({
    ...
    methods: {
        ...
        submitPost: function (index) {
            ...
            let datePattern = /^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-8]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))$/;
            try {
                /* 字符串处理为数组 */
            ...
            switch (index) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if (post.date == null || post.place == null || post.num == null || post.gotten == null || post.title == null || post.pAgree == null || post.pDisagree == null) {
                        window.alert('信息不全');
                        this.emptyPost();
                        return;
                    }
